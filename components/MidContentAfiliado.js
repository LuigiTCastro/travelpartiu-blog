...
export default function MidContentAfiliado({ categoria }) {
  ...
  return (
    <a
      ...
      className="my-8 flex p-4 bg-bg-accent border-l-[3px] border-primary rounded-r-xl not-prose hover:bg-bg-accent/80 transition-colors block"
    >
      <div>
        ...
        <span className="inline-flex items-center gap-1.5 text-[0.8125rem] font-semibold text-primary hover:text-primary-hover transition-colors">
          {af.cta}
